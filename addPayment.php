...
?>
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Add Record</h1>
...
<form action="insertPayment.php" method="post">
   ...
   <input style="display:none" type="text" name="recipt_no" value="<?php echo"$uniqueId"; ?>" required><br>
 <input style="display:none" type="text" name="client_id" value="<?php echo"$client_id"; ?>" required><br>
