...
?>
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Status
						<button class="btn" align="center" style="background:linear-gradient(120deg,#191970, #900C3F ,#581845);
color: white;"> 
                        <a href="addclient.php" class="btn" style="
background:linear-gradient(120deg,#191970, #900C3F ,#581845);
color: white;">Add Client</a>
                        </button>
						</h1>
...
if ($conn->query($sql) === TRUE) {
    echo "deleted successfully";  echo '</br>';
} else {
    echo "Error deleting: " . $conn->error;  echo '</br>';
}
