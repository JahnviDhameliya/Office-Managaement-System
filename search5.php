...
?>
        <!-- /. NAV SIDE  -->
            ...
            <?php
	   $key       = $_POST["key"];
///////    SEARCHES IN purchase
	   
$sql="SELECT * FROM purchase WHERE date LIKE '%" . $key .  "%' OR ac_name LIKE '%" . $key ."%' OR bill_number LIKE '%" . $key ."%' OR bill_type LIKE '%" . $key ."%' OR payment_mode LIKE '%" . $key ."%'  ";  
