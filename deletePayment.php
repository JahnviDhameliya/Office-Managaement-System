...
?>
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Record deleted successfully
						<button class="btn" align="center" style="background:linear-gradient(120deg,#191970, #900C3F ,#581845);color: white;"> 
                        <a href="home.php" class="btn" style="background:linear-gradient(120deg,#191970, #900C3F ,#581845);color: white;">HOME</a>
                        </button>
						</h1>
