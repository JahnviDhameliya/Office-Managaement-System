...
?>
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Cancel Register
    ...
    <br>
            ...
            if($s_date=="" or $e_date==""){
                $sql = "SELECT * FROM payment where warranty='1' and agent_id='$agent_id' order by action and month";

            }
            
    else if($s_date!="" or $e_date!=""){
        $sql = "SELECT * FROM payment where warranty='1' and agent_id='$agent_id' AND action between '$s_date' and '$e_date' order by action and month";
	...
	//$sql = "SELECT * FROM payment where warranty='1' and agent_id='$agent_id' order by action";
